// We thank the anonymous reviewer who has provided sample code for their criterion/cpu_time setup.
// Adapted from https://github.com/YangKeao/criterion-cpu-time to use the cpu_time crate
